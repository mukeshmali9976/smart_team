...
public class ReportListActivity extends BaseAppCompatActivity implements View.OnClickListener ,
        RequestListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        prefManager = CryptoManager.getInstance(ReportListActivity.this).getPrefs();
