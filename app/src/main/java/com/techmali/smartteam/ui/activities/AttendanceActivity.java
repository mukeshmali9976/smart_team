...
public class AttendanceActivity extends BaseAppCompatActivity implements View.OnClickListener,
        RequestListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        prefManager = CryptoManager.getInstance(AttendanceActivity.this).getPrefs();
    ...
    private void initView() {
        ...
        mAdapter = new AttendanceAdapter(AttendanceActivity.this, listModels);
