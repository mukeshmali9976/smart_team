...
/**
 * The Image view touch for zoom in/out images.
 *
 * @author Vijay Desai
 */
public class ImageViewTouch extends ImageViewTouchBase {
    /**
     * The Scroll delta threshold.
     */
    ...
    /**
     * Gets quick scale enabled.
     *
     * @return the quick scale enabled
     */
    @TargetApi(19)
     ...
     *
     * @param direction - positive direction value means scroll from right to left,                  negative value means scroll from left to right
